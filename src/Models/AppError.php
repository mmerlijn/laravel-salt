 ...
 */
#[UseResource(AppErrorResource::class),ObservedBy(AppErrorObserver::class)]
class AppError extends Model
{
    ...
    {
        return $this->hasMany(Flow::class, 'app_error_id');
    }
    ...
    {
        $this->flows()?->update(['app_error_id' => null]);
    }

    protected static function newFactory(): AppErrorFactory
    {
        return AppErrorFactory::new();
    }
}
